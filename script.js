...
const modules = [
    ...
    },
    {
        ...
        theory: `
            ...
            nomDaFuncao(argumento1, argumento2); // Chamada da função
            </pre>
            <p class="text-slate-600 mb-4">Outra maneira de declarar funções é usando uma expressão <strong>arrow funcions</strong> possui uma sintaxe mais curta. </p>
            <pre class="bg-slate-900 text-white p-4 rounded-lg text-sm mb-4">
                () => {
                    // código
                }
        ...
        `,
        initialCode: `function soma_nota(nota1, nota2) {
        return nota1 + nota2;
        }
        const nota_final = soma_nota(8, 7);
        console.log("Nota final:", nota_final);
        
        /* Exemplo com arrow functions */
        
        let elementos_quimicos = ["Lítio","Sódio"];
        elementos_quimicos.map(
    ...
    },
    {
        ...
        theory: `
            ...
            <p class="text-slate-600 mb-4">Vamos começar com um exemplo bem simples:</p>
            <img  src="./assets/dom.svg" class="mb-2" />
            ...
            <p class="text-slate-600 mb-4">Para conhecer mais sobre manipulação da DOM, acesse: <a href="https://developer.mozilla.org/pt-BR/docs/Web/API/Document_Object_Model/" class="text-blue-500 hover:underline" target="_blank">DOM em JavaScript</a></p>
        `,
